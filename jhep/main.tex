...
Furthermore, this observable exhibits smaller scale dependence then ratios of cross sections at different centre-of-mass energies.}

\begin{figure}
    \centering
    \includegraphics[width=1.00\textwidth]{figs/prosa-scale-vars.pdf}
    \caption{NLO QCD predictions for LHCb data for $D^{0}$ meson production at $\sqrt{s} = 13$~TeV (top row), 
      ...
      with their PDF uncertainties obrained using the HERAPDF2.0 PDF set with three active falvours (\texttt{HERAPDF20\_NLO\_FF3A\_EIG} and \texttt{HERAPDF20\_NLO\_FF3A\_VAR} LHAPDF sets) and different scale choices for two representative $p_T$ regions 
