...
The performance of the new PDFs presented here was tested by computing predictions for the textcolor{red}{inclusive or multi-jet?} production in DIS and jet and top quark-antiquark protuction in proton-proton collisions. The VFNS variant of the presented PDFs is used. The resulting predictions are compared to the measurements by H1~\textcolor{red}{REF}, ZEUS~\textcolor{red}{REF} and CMS~\textcolor{red}{REF} experiements in \textcolor{red}{would be great to have 2 representative examples in a Figure}. The results are found similar to those using HERAPDF2.0 PDF.
